...
| [`editor.status`](../Editor/Providers/EditorStatusProvider.cs) | Editor state: isPlaying, isPaused, isCompiling, editorFocused, lastUserActivityAt, editorIdleForMs, activeScene, unityVersion, projectPath, mainThreadStalledMs (>0 means tools are likely timing out), and worker batch/ownership/graphics state. |
